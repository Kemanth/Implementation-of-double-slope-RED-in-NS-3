...
int main (int argc, char *argv[])
{
  ...
  cmd.AddValue ("queueDiscType", "Set Queue disc type to RED or DSRED", queueDiscType);
  ...
  if ((queueDiscType != "RED") && (queueDiscType != "DSRED"))
    {
      std::cout << "Invalid queue disc type: Use --queueDiscType=RED or --queueDiscType=DSRED" << std::endl;
      exit (1);
    }
